...
\usepackage{tikz}
\usetikzlibrary{shadows.blur, positioning, decorations.pathreplacing, calc, decorations.pathmorphing}
\usepackage{xifthen}
...
\title{\textbf{Collection of Funny PGF Tips}}
\author{Zheng Rui}
\date{\today}
...
\newcommand\githublogo{\raisebox{-1pt}{\resizebox{36pt}{!}{\github}}}
...
\newcommand\eyelogo{\raisebox{-4pt}{\resizebox{36pt}{!}{\eye}}}

% by default, only latex/pdflatex/lualatex supports image as hyperlink
% xelatex only supports text as hyperlink, to enable it:
% http://tex.stackexchange.com/questions/84921/href-not-working-with-image-but-ok-with-text

\ifxetex
  \setlength{\XeTeXLinkMargin}{1pt}
  \newcommand\hypereyelogo{
    \XeTeXLinkBox{\eyelogo}  % just put things inside \XeTeXLinkBox
  }
\fi
...
\vspace*{2em}
\begin{center}
\Huge \textbf{Collection of Funny PGF Tips}
\end{center}
...
\href{http://tex.stackexchange.com/questions/84921/href-not-working-with-image-but-ok-with-text}{\hypereyelogo}

DingSymbols - Download

\raisebox{10pt}{\rotatebox{-90}{\color{black} \Large \ding{224}}}
